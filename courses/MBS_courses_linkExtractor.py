...
# MAIN ROUTINE
courses_page_url = 'https://mbs.edu/degree-programs'
site_url = 'https://mbs.edu/'
list_of_links = []
...
result_elements = soup.find_all('div', attrs={"class": "tile-title"})
...
# SAVE TO FILE
course_links_file_path = os.getcwd().replace('\\', '/') + '/MBS_courses_links.txt'
